...
%% SECOND-ORDER COMPARISONS
      ...
      function showSig(obj,self,ax)
         ...
         upperX = vectify(repmat(1:n,2,[]))*sqSz;
         patch(boxPos(1)+upperX,boxPos(2)+shift(upperX-sqSz,-1),...
               [0.8 0.8 0.8],'EdgeColor','none')
         patch(boxPos(1)+shift(upperX-sqSz,-1),boxPos(2)+upperX,...
               [0.8 0.8 0.8],'EdgeColor','none')
         ...
         if isempty(sig.ra)
            ...
            for i = 1:nCatsc2
               rectangle('Position',[boxPos+[(i-0.5)*sqSz csep] 0.5*[sqSz sqSz]],...
                         'FaceColor',obj.categories.colors(ix(1,i),:),'Curvature',1,...
                         'EdgeColor',obj.categories.colors(ix(1,i),:))
               rectangle('Position',[boxPos+[csep (i-0.5)*sqSz] 0.5*[sqSz sqSz]],...
                         'FaceColor',obj.categories.colors(ix(1,i),:),'Curvature',1,...
                         'EdgeColor',obj.categories.colors(ix(1,i),:))
               rectangle('Position',[boxPos+[(i-1  )*sqSz csep] 0.5*[sqSz sqSz]],...
                         'FaceColor',obj.categories.colors(ix(2,i),:),'Curvature',1,...
                         'EdgeColor',obj.categories.colors(ix(2,i),:))
               rectangle('Position',[boxPos+[csep (i-1  )*sqSz] 0.5*[sqSz sqSz]],...
                         'FaceColor',obj.categories.colors(ix(2,i),:),'Curvature',1,...
                         'EdgeColor',obj.categories.colors(ix(2,i),:))
            end
         end
